...
enum PDE_TYPE
{
  POISSON = 0,  // representative for scalar-valued eqn
  KELVIN,       // representative for matrix-valued eqn
  HELMHOLTZ     // representative for complex-valued eqn
};
...
template <>
struct pde_trait<PDE_TYPE::POISSON>
{
...
template <>
struct pde_trait<PDE_TYPE::KELVIN>
{
  typedef double  scalar_t;
  typedef int32_t index_t;
  typedef double  real_t;
...
template <>
struct pde_trait<PDE_TYPE::HELMHOLTZ>
{
  typedef thrust::complex<double> scalar_t;
  typedef int32_t                 index_t;
  typedef double                  real_t;
  static const int d = 1;
};
