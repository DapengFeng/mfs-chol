...
images=("dat/rose.jpg" "dat/firefox.png" "dat/cherrytomato.jpg" "dat/mango.jpg" "dat/pixabay/cello-ributov-L.jpg" "dat/pixabay/tulip-Ilo-L.jpg" "dat/pixabay/tiles-stocksnap-L.jpg")
...
for low_thr in 25; do
    outdir=result/kl_res/small_figs_for_video/${name}/thr-${low_thr}
    mkdir -p ${outdir}
