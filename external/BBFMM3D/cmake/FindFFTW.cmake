...
find_path(FFTW_INCLUDE_DIR NAMES fftw.h rfftw.h
  ${FFTW_ROOT}/include
  ...
  /usr/local/include
  /usr/include
  DOC "Specify the directory containing fftw.h"
)
...
#find FFTW library
find_library(FFTW_LIBRARY NAMES fftw PATHS
  ${FFTW_ROOT}/lib
  $ENV{FFTW_ROOT}/lib
  ${FFTW_ROOT}/lib64
  $ENV{FFTW3}
  ...
  /usr/local/lib
  /usr/lib
  DOC "Specify the fttw library here."
)

find_library(RFFTW_LIBRARY NAMES rfftw PATHS
  ${FFTW_ROOT}/lib
  $ENV{FFTW_ROOT}/lib
  ${FFTW_ROOT}/lib64
  $ENV{FFTW3}
  ...
  /usr/local/lib
  /usr/lib
  DOC "Specify the rfttw library here."
)

set(CMAKE_FIND_LIBRARY_SUFFIXES ${CMAKE_FIND_LIBRARY_SUFFIXES_SAV})

if (FFTW_INCLUDE_DIR AND FFTW_LIBRARY AND RFFTW_LIBRARY)
  set(FFTW_FOUND 1)
  if (NOT FFTW_FIND_QUIETLY)
     #message(STATUS "Found fftw3 include directory at ${FFTW_INCLUDE_DIR}")
     message(STATUS "Looking for FFTW... found ${FFTW_LIBRARY} ${RFFTW_LIBRARY}")
...
set(FFTW_LIBRARIES ${RFFTW_LIBRARY} ${FFTW_LIBRARY})
